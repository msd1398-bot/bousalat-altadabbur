      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <NavLink
            to="/"
            className={({ isActive }) =>
              `flex items-center gap-1 sm:gap-2 px-3 sm:px-4 md:px-6 py-2 rounded-lg transition-all duration-300 ${
                isActive
          ...
          >
            ...
            <span className="hidden sm:inline font-medium" style={{ fontFamily: 'Traditional Arabic, Arial' }}>الرئيسية</span>
          </NavLink>
          ...
          >
            ...
            <span className="hidden sm:inline font-medium" style={{ fontFamily: 'Traditional Arabic, Arial' }}>دليل المسلم</span>
          </NavLink>
          ...
          >
            ...
            <span className="hidden sm:inline font-medium" style={{ fontFamily: 'Traditional Arabic, Arial' }}>يومياتي</span>
          </NavLink>
          </div>
        </div>
      </div>
